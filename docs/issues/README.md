...
|---|---|---|---|---|
| [0001](0001-dotfiles-dmail-receiver-systemd.md) | exe-coder VM に dmail-receiver / dmail-emitter を systemd unit として deploy | `hironow/dotfiles` | 📝 未着手 | 0002, 0003 |
...
| [0005](0005-async-span-flush.md) | goroutine 内 span が Cloud Run idle shutdown までに flush されず lost する | `hironow/runops-gateway` | 🟡 RED test 起票済、GREEN 実装は調査結果待ち | 0004 視認性 |
